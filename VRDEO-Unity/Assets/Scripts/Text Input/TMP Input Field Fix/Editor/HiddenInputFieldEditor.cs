...
namespace TMPro.EditorUtilities {
    ...
    [CustomEditor(typeof(HiddenInputField), true)]
    public class HiddenInputFieldEditor : SelectableEditor {
        ...
        public override void OnInspectorGUI() {
            ...
            if (m_foldout.fontSettings) {
                ...
                if (EditorGUI.EndChangeCheck()) {
                    HiddenInputField inputField = target as HiddenInputField;
                ...
                if (!m_ContentType.hasMultipleDifferentValues) {
                    ...
                    if (m_ContentType.enumValueIndex == (int)HiddenInputField.ContentType.Standard ||
                        m_ContentType.enumValueIndex == (int)HiddenInputField.ContentType.Autocorrected ||
                        m_ContentType.enumValueIndex == (int)HiddenInputField.ContentType.Custom) {
                        EditorGUI.BeginChangeCheck();
                        EditorGUILayout.PropertyField(m_LineType);
                        if (EditorGUI.EndChangeCheck()) {
                            if (text != null) {
                                if (m_LineType.enumValueIndex == (int)HiddenInputField.LineType.SingleLine)
                    ...
                    if (m_ContentType.enumValueIndex == (int)HiddenInputField.ContentType.Custom) {
                        ...
                        if (m_CharacterValidation.enumValueIndex == (int)HiddenInputField.CharacterValidation.Regex) {
                            EditorGUILayout.PropertyField(m_RegexValue);
                        }
                        else if (m_CharacterValidation.enumValueIndex ==
                                 (int)HiddenInputField.CharacterValidation.CustomValidator) {
            ...
            if (m_foldout.extraSettings) {
                ...
                EditorGUILayout.PropertyField(m_ResetOnDeActivation,
                    new GUIContent("Reset On DeActivation",
                        "Should the Text and Caret position be reset when Input Field is DeActivated."));
